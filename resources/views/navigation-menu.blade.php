    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('oppurtunity_cat.create') }}"
                        :active="request()->routeIs('oppurtunity_cat.create')">
                        {{ __('Add Category') }}
                    </x-jet-nav-link>
                </div>
                @endif
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('project_index') }}" :active="request()->routeIs('project_index')">
                        {{ __('Add Projects') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
