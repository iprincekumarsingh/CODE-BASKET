    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-a00e">
        <div class="u-align-left u-clearfix u-sheet u-sheet-1">
            <div class="u-form u-form-1">
                <form action="{{route('oppurtunity_cat.store')}}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="u-form-group u-form-name u-label-top">
                        ...
                        <input type="text" placeholder="Enter Cateogry Name" id="name-5a1e" name="cat_name"
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <td><img src="{{url('upload/category_img/'.$data['Category_Photo'])}}" width="100px" height="50px" alt=""></td>
                        <td>{{$data['name']}}</td>
                        <td>
                            <a class="btn btn-danger" href="{{route('oppurtunity_cat.delete',['id'=>$data['cat_id']])}}">Delete</a>
                        </td>
                      </tr>
