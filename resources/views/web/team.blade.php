      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="row section-secondary ourTeam-box text-center">
              <div class="col-md-12 section1">
                <img src="{{url('frontend/assets/img/pri.jpg')}}">
              </div>
              <div class="col-md-12 section2 pb-3">
                <p>PRINCE KUMAR SINGH</p>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="row section-info ourTeam-box text-center">
              <div class="col-md-12 section1">
                <img src="{{url('frontend/assets/img/pra.jpg')}}">
              </div>
              <div class="col-md-12 section2 pb-3">
                <p>PRAGATI SAIKIA</p>
                <span>Frontend, Content Manager.</span>
              </div>
              <div class="col-md-12 section3">
                <i class="bx bxl-github" aria-hidden="true"></i>
                <i class="bx bxl-linkedin" aria-hidden="true"></i>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="row section-danger ourTeam-box text-center">
              <div class="col-md-12 section1">
                <img src="{{url('frontend/assets/img/udit.jpeg')}}">
              </div>
              <div class="col-md-12 section2 pb-3">
                <p>UDITYA RAJ</p>
